...
var tryRandomRemove = function(trait) {
  var no_remove = ["brow", "ear", "eye", "eyelash", "hair", "mouth", "jaw", "nose", "pupil_tone", "skin_tone", "body", "face_proportion", "eye_spacing", "eye_size"];
  if (~no_remove.indexOf(getKey(trait)) || Math.random() > 0.5) {
